      ...
      <div class="flex-1 lg:flex flex-col bg-gray-25">
        <div class="lg:flex space-y-6 w-full flex-1 overflow-hidden">
            ...
            <transition name="flip" mode="out-in">
              ...
              <div v-else class="h-full bg-white">
                <div class="flex items-center p-4 border-b">
                  ...
                  <NuxtLink to="/dashboard/notifications" class="text-[#667185] font-medium text-sm">Notification |
                  </NuxtLink>
                  <h1 class="text-sm text-[#1D2739] font-semibold pl-2">{{ selectedNotification?.notification?.title }}
                  </h1>
                </div>
                <div class="p-6">
          ...
          <section class="hidden lg:flex space-y-6 w-full flex-1 overflow-hidden">
            ...
            <div v-else class="flex-1 flex py-20 items-center justify-center bg-gray-25">
              <div class="flex justify-center items-center flex-col w-full gap-y-4">
                <svg width="152" height="124" viewBox="0 0 152 124" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="76" cy="58" r="52" fill="#EAEAEA" />
                  <circle cx="21" cy="25" r="5" fill="#BDBDBD" />
