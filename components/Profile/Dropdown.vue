<template>
    <div class="relative">
      ...
      >
        ...
        <NuxtLink to=/dashboard/profile class="font-semibold"> {{ user?.firstName }} {{ user?.lastName }}</NuxtLink>
      ...
      <NuxtLink
        to="/dashboard/profile/contact-us"
        class="flex items-center px-4 py-3 text-[#1D2739]  space-x-3"
      >
        <svg
          width="20"
      ...
      <NuxtLink
        to="/dashboard/profile/emergency-contact"
        class="flex items-center px-4 py-3 text-[#1D2739]  space-x-3"
      >
        <svg
          width="20"
